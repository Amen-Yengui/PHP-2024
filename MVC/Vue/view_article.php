...
<body>
    ...
    //-------------------------------------------
    ?>
    <form action="../Vue/view_article.php" method="POST">
    ...
    if (isset($_POST['filter'])) {
        ...
        echo "<tr><th>référence</th><th>Libellé</th><th>fournisseurs</th><th>Prix</th><th>Qte stock</th><th>Image</th><th>Ajouter Image</th><th>Action</th></tr>";
        foreach ($listArticles as $Art) {
            ...
            if (!empty($image_files)) {
                ...
                // Afficher l'image
                echo "<td><img src= $first_image width=150px> <br>
                <a href='../Vue/photo_view.php?refmdf=" . $Art->reference . "'>Modifier </a></td>";
            } else {
                echo "<td><a href='../Vue/photo_view.php?refimg=" . $Art->reference . "'>Ajouter </a></td>";
            }

            echo "<td><a href='../Vue/photo_view.php?refsupp=" . $Art->reference . "'>Ajouter </a></td>";
            echo "<td><a href='../Control/ControlArticle.php?refsupp=" . $Art->reference . "'>Supprimer</a></td>";
