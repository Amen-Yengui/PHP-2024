...
<body>
    ...
    <table class='tab'>
        ...
        foreach ($listArt as $Art) {
            ...
            echo "<td>" . $Art->prix . "</td>";
            echo "<td>" . $Art->Qte . "</td>";
            echo "<td><a href='../control/ControlArticle.php?refsupp=" . $Art->reference . "'>Supprimer</a>
            <br><a href='addPanierView.php?refajou=" . $Art->reference . "'>Ajouter au panier</a>
            <br><a href='photo_view.php?ref=" . $Art->reference . "'>Ajouter photo</a></td>";
            echo "</tr>";
        }
