...
echo "<tr><th>Référence </th> <th>Libellé</th><th>Prix</th><th>Qte en stock</th></tr>";
echo  "<tr><td>$l->ref </td><td>$l->libelle </td><td>$l->prix</td><td> $l->Qt_stock</td></tr>";
echo "</table>";


?>
<br><br>
<form action="ControlePanier.php" method="POST">
    <table>
        <tr>
